...
trait SurfaceMarcher extends Intersectable {
	...
	def gradient(pt: Vec3): Vec3 = {
		val grad_x = (equation(pt)-equation(pt - Vec3(x=0.00001)))*100000;
		val grad_y = (equation(pt)-equation(pt - Vec3(y=0.00001)))*100000;
		val grad_z = (equation(pt)-equation(pt - Vec3(z=0.00001)))*100000;
